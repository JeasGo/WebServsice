 ...
 * generated in the cn.itcast.cxf.client.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetAddressByMobileNo_QNAME = new QName("http://server.cxf.itcast.cn/", "getAddressByMobileNo");
    private final static QName _GetAddressByMobileNoResponse_QNAME = new QName("http://server.cxf.itcast.cn/", "getAddressByMobileNoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.cxf.client.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.itcast.cn/", name = "getAddressByMobileNo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.itcast.cn/", name = "getAddressByMobileNoResponse")
